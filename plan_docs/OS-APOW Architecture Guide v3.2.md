...
* **Environment:** A high-fidelity DevContainer built from the workflow-orchestration-queue-papa89.  
* **Worker Capabilities:**  
...
1. **Bootstrap:** The developer manually clones the workflow-orchestration-queue-papa89.  
